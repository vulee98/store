							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
										...
										<input required type="number" name="price" class="form-control" value="11990000">
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
										...
										<input required type="text" name="promotion" class="form-control" value="dán cường lực">
									</div>
									<div class="form-group" >
										<label>Tình trạng</label>
										<input required type="text" name="condition" class="form-control" value="mới">
									</div>
									<div class="form-group" >
